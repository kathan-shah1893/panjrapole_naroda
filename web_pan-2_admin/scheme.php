	   ...
	   <div class="inner-content">
								...
								<!--sub-heard-part-->
								   ...
								   <ol class="breadcrumb m-b-0">
										...
										<li class="active">New Scheme</li>
									</ol>
								   </div>
								  <!--//sub-heard-part-->
								<div class="graph-visual">
											<h2 class="inner-tittle">Create a new scheme</h2>
											<center>						
											<form method="post" enctype="multipart/form-data" class="cls">
												<h4>Enter Data</h4>
												<textarea id="phone" name="image" required="" ></textarea><br>
 ...
 if (isset($_POST['clk']))
  {
 					...
 					$sql="INSERT INTO scheme(file)VALUES('$image_path')";
