	...
	<div class="left-content">
	   <div class="inner-content">
								...
								<div class="graph-visual">
											<h2 class="inner-tittle">Edit gallary</h2>
  ...
  while($row=$ans->fetch_assoc())
   {
   	...
   	echo "<td>".$i."</td>"; 
		echo "<td>".$row['id']."</td>";
		echo "<td><img src='../web_pan-2/gallary/".$row['file']."' height='200px'></td>";
		echo "<td>".$row['date']."</td>";
		$i=$i+1;?>
		<td><a href='?del=<?php echo $row['id']; ?>' onclick="return confirm('Are You Sure?');">DELETE</a></td>
										<!--//outer-wp-->
									</div>
								</div>
								</div>
...
echo " </table>";
									 if(isset($_GET['del']))
									    {
                    					  $querya="DELETE FROM gallary WHERE id=".$_GET['del']."";
